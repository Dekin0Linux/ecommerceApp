    ...
    return (
        <div className='container mx-auto'>
            ...
            <div className='bg-white md:flex md:h-[600px] md:gap-x-5 gap-y-10'>
                <div className='shadow-xl md:w-60 w-full flex md:block justify-between p-5'>
                    {
                        category.map((item, index) => (
                            <Link to={`/category/${item}`} key={index}>
                                <p className='mb-1 hover:shadow-md p-2 capitalize font-light md:text-xl '>{item}</p>
                            </Link>
                        ))
                    }
                </div>
            ...
            <div className='shadow-lg p-10 '>
                ...
                <div className='flex md:gap-8 gap-3 md:justify-around flex-wrap'>
                    {
